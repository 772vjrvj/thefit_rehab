...
@section('content')
    ...
    <!-- About-2 Area End -->
    <section class="wantToWork-area section-bg3" data-background="{{ asset('img/gallery/section_bg01.png') }}">
        <div class="container">
            <div class="wants-wrapper w-padding2">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <a href="/services" class="btn f-right sm-left">Take a Service</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="home-blog-single mb-40">
                        <div class="blog-img-cap">
                            ...
                            <div class="blog-cap">
                                <h3><a href="/blog_details">Your daily meal plan</a></h3>
